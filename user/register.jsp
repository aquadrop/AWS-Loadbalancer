...
<html>
	...
	<body data-spy="scroll" data-target=".subnav" data-offset="50">
			...
			<div class="navbar-inner">
				<div class="container">
					...
					<div class="nav-collapse pull-right">
						<ul class="nav">
							<li><a href="Login" icon="lock">User Login</a></li>
		...
		<div class="container">
			...
			<div id="content">
				<h2>Register</h2>
				<form action="Register" id="UserLoginForm" method="post" accept-charset="utf-8">
					...
					<div class="input password">
						...
						<input name="password_confirm" placeholder="Enter Your Password Again" type="password" id="password_confirm" />
					</div>
